...
pub fn expect_events(e: Vec<RuntimeEvent>) {
	expect_event::<RuntimeEvent, Test>(e);
}

pub fn expect_event<TEvent: std::fmt::Debug + PartialEq, TRuntime: frame_system::Config>(
	e: Vec<TEvent>,
) where
	Vec<TEvent>: FromIterator<<TRuntime as frame_system::Config>::RuntimeEvent>,
{
